...
public abstract class BaseSubscriber<T> extends DisposableObserver<T> {
    ...
    public void onNext(@NonNull T t) {
        Log.e("","-->http is onNext" + t.toString());
    }

    @Override
    public final void onError(Throwable e) {
        Log.e("","-->http is onError");
        if (e instanceof ApiException) {
            Log.e("","--> e instanceof ApiException err:" + e);
            onHttpError((ApiException) e);
        } else {
            Log.e("","--> e !instanceof ApiException err:" + e);
    ...
    public abstract void onHttpError(ApiException e);
